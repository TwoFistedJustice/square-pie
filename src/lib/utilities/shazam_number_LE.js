/* Returns true = good
 * */
/** shazam_number_LE compares a number to a limit. If the number is less than the limit it returns true and otherwise throws an error.
 *
...
const shazam_number_LE = function (
  num,
  limit,
  ...
  if (!(num <= limit)) {
    let message =
      ...
      "." +
      caller +
      " number must be no smaller than " +
      limit +
      " . Received " +
      num;
...
module.exports = shazam_number_LE;
