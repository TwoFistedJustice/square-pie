...
describe("Invoice_Update - Validation", () => {
  let update, pie_invoice_object, make, fardel, square_invoice;
  ...
  // todo failing
  /*
   *  is_updatable is getting called TWICE!
   * */
  ...
  test("reason: a status of PAYMENT_PENDING, PAID, REFUNDED, CANCELED, or FAILED", () => {
    ...
    let expected = base_reason + "This works literally everywhere but here";
    expect(thing.reason).toEqual(expected);
  });

  //todo failing - but only if above test is active
  ...
  test("reason: versions not equal ", () => {
    ...
    update.validate(pie_invoice_object);
    expect(update.reason).toEqual(expected);
  });
...
// #is_invoice_published() should set true when status is UNPAID
// #is_invoice_published() should set true when status is SCHEDULED
// #is_invoice_published() should set true when status is PARTIALLY_PAID
// #is_invoice_published() should set true when status is PARTIALLY_REFUNDED
// #is_invoice_published() should set false when status is DRAFT

// #is_updatable() should set false when status is PAID
// #is_updatable() should set false when status is REFUNDED
// #is_updatable() should set false when status is CANCELED
// #is_updatable() should set false when status is FAILED
// #is_updatable() should set false when status is PAYMENT_PENDING
// #is_updatable() should set true when status is DRAFT
